...
*  {% colwidth=[192] %}
   ...
   **Идентификатор заказчика, категория услуги (сантехник, электрик, сборка мебели), описание проблемы, адрес и координаты объекта**

*  {% colwidth=[239] %}

   **Идентификатор созданной заявки, статус заявки и время её создания**
...
*  {% colwidth=[156] %}
   ...
   **Сервис подбора мастеров**

*  {% colwidth=[156] %}

   **Получить новые заявки для рассылки уведомлений**

*  {% colwidth=[156] %}

   **Периодически или по событию запрашивать список неназначенных заявок по городу**

*  {% colwidth=[192] %}

   **Статус заявки (новая) и город поиска**

*  {% colwidth=[239] %}

   **Список новых заявок с адресом, координатами, категорией услуги и временем создания каждой заявки**

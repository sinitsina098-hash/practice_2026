...
Уточнение: В pets id питомцев остались int64, потому что в микросервисе питомцев будут использоваться внутренние идентификаторы.
...
*  {% colwidth=[383] %}
   ...
   изменить один из параметров (необяз.): имя пользователя, почта
...
*  {% colwidth=[383] %}
   ...
   сделать запрос в БД по id для удаления соответствующей записи об УЗ пользователя
...
*  {% colwidth=[134] %}
   ...
   FE, clients-srv и микросервис питомцев

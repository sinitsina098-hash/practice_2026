...
Пароль будет хранить внешний провайдер (например, keycloak). фронт получает токен от ldP, и с ним ходит в clients-srv, поэтому эндпоинт с входом/выходом я убрала. Функциональность:
